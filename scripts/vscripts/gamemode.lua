...
function GameMode:OnGameInProgress()
  ...
  --local player = PlayerInstanceFromIndex(1) --[[Returns:handle
  ...
  Timers:CreateTimer(5, -- Start this timer 5 game-time seconds later
    function()
      ...
      local current_players = PlayerResource:GetPlayerCount()
      DebugPrint("Current players", current_players)

      for playerID=1, current_players do
        --local player = PlayerResource:GetPlayer(playerID)
        local player = PlayerInstanceFromIndex( playerID)
        DebugPrint(player)

        --local player2 = player:GetPlayerID
        --DebugPrint(player2)
      ...
      --local kobold = CreateUnitByName("npc_dota_neutral_kobold", position, true, hero, hero, hero:GetTeamNumber())
      local kobold = CreateUnitByName("human_footman", position, true, hero, hero, hero:GetTeamNumber())

      end
--[[CreateUnitByName(string a, Vector b, bool c, handle d, handle e, int f) Returns:handle
